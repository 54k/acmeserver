...
import com.acme.engine.aegis.events.Event;
import com.acme.engine.aegis.events.EventListener;
import com.acme.engine.aegis.events.Signal;
import com.acme.engine.aegis.utils.ImmutableList;
import com.acme.engine.aegis.utils.Pool;
import com.acme.engine.aegis.utils.Pool.Disposable;
...
public class Engine {
    ...
    private void registerDefaultProcessors() {
        processors.add(new EventBinder());
        processors.add(new SystemBinder());
    }
